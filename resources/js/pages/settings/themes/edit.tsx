...
import { Theme, ThemeProperty, ElementType } from '@/types/theme';
...
interface Props {
    theme: Theme;
    themePropertyStructure: ThemeProperty[];
    fonts: string[];
    weights: string[];
    returnUrl?: string;
}
...
export default function Edit({ theme, themePropertyStructure, fonts, weights }: Props) {
    ...
    const renderField = (property: ThemeProperty, path: string[] = []) => {
        ...
        if (type === ElementType.Object && properties) {
            return (
                    ...
                    <CardContent className="p-0">
                        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                            <TabsList className="grid w-full grid-cols-3 mb-4">
                                {themePropertyStructure.map(section => (
