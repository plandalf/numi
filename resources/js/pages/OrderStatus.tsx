                ...
                <div>
                  ...
                  <div className="text-sm text-gray-900 font-medium">
                    {order.checkout_session?.payment_method ? (
                      <>
                        {order.checkout_session.payment_method.brand ? (
                          <>{order.checkout_session.payment_method.brand.charAt(0).toUpperCase() + order.checkout_session.payment_method.brand.slice(1)}&nbsp;</>
                        ) : null}
                        {order.checkout_session.payment_method.type === 'card' && order.checkout_session.payment_method.last4 ? (
                          <>ending in {order.checkout_session.payment_method.last4}</>
                        ) : null}
