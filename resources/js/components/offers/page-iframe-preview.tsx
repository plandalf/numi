...
export function PageIframePreview() {
  ...
  const isHosted = offer.is_hosted && previewType === 'desktop';
  ...
  return (
    <div className="w-full h-full flex items-center justify-center">
      ...
      <div className="flex items-center gap-2 px-4 py-2 border-b border-border bg-muted/50">
        ...
        {/* Address bar */}
        <div className="flex-1 min-w-0 flex items-center gap-2 px-3 py-1.5 bg-background rounded-md border border-border">
          ...
          <div className="min-w-0 flex-1">
            <span className="text-sm text-muted-foreground block truncate">{offerUrl}</span>
          </div>
        </div>
      </div>
